...

  {
...

    {
...

      {
        ...
        echo $this->evaluation_model->update_subject_evaluation();
...

      {
        ...
        echo $this->evaluation_model->insert_subject_evaluation();
...

  {
...

    {
...

      {
        ...
        echo $this->evaluation_model->update_student_evaluation();
...

      {
        ...
        echo $this->evaluation_model->insert_student_evaluation();
...

  {
...

    {
...

      {
        ...
        echo $this->evaluation_model->update_parent_evaluation();
...

      {
        ...
        echo $this->evaluation_model->insert_parent_evaluation();
...

  {
...

    {
...

      {
        ...
        echo $this->evaluation_model->update_terminal_comment();
...

      {
        ...
        echo $this->evaluation_model->insert_terminal_comment();
