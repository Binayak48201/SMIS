		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
		        ...
		        <a href="javascript:history.go(-1)"><div id="dashboard-report-range" class="tooltips btn btn-fit-height btn-sm green-haze btn-dashboard-daterange" data-container="body" data-placement="left" data-original-title="" title="">
	            ...
	            <div class="user-card">
	              ...
	              <div class="div-top" style='box-shadow: none !important; height: 300px'>
	                ...
	                <div class="user-photocont">
	                	...
	                	<img src="<?= file_exists(IMG_UPLOAD_PATH."/".$info->picture_path) ? site_url('uploads/'.$info->picture_path).'?dump='.rand() : site_url('assets'); ?>/admin/layout2/img/avatar.png ?>" width="165px" class="img-responsive user-img-pro" alt='<?=$info->first_name.' '.$info->middle_name.' '.$info->last_name?>' >
