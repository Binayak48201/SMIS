							...
							<!-- PORTLET MAIN -->
								...
								<ul class="list-group">
									...
									<li class="list-group-item hover">
										<a target="#marksheet" href="<?= site_url('pages/reports/academic_report/view_marksheet/'); ?>">Academic Details</a>
									</li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane <?= isset($active) ? : 'active' ?>" id="tab_1_1">
											<div class="col-md-12"> 
												<table class="table">
													<tr>
														<td><strong>University Exam Roll No:</strong></td>
														<td></td>
														<td title="<?=$results->USER_NAME?>"><strong>Roll No:</strong> </td>
														<td><?=$results->current_roll?></td>
													</tr>
													<tr>
																...
																<div class="panel panel-success">
																	...
																	<div id="accordion2_<?php echo $i;?>" class="panel-collapse collapse">
																		<div class="panel-body">
																			<?php 
																			if(!check_st_restrict($results->student_id,$results->joined_batch,$exam->numeric_value,$results->grade))
  																		{	?>
															...
															?>
																<div class="panel panel-success">
																	...
																	<div id="accordion2_<?= AGGREGATE_ID;?>" class="panel-collapse collapse">
																		<div class="panel-body">
																			<?php 
																			if(!check_st_restrict($results->student_id,$results->joined_batch,AGGREGATE_ID,$results->grade))
  																		{	?>
										...
										<div class="tab-pane" id="tab_1_3">
												...
												if(isset($st_evaluations)){
													...
													foreach($st_evaluations as $st_evaluation)
													{
														...
														<div class="panel panel-success">
															<div class="panel-heading">
																<h4 class="panel-title st_evaluation"  data-caption="Evaluation on <?=$st_evaluation->terminal_name?>" data-toggle="modal" data-target="#st_evaluation" data-section-id="<?= $results->section_id ?>" data-id="<?= $st_evaluation->exam_id ?>" >
																<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#accordion2_<?=$i;?>">
