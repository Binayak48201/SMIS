								...
								<div class="portlet-title tabbable-line">
										...
										<?php 
											foreach ($departments as $key => $department) {
												...
												<li class="<?= $key == 0 ? 'active' : '' ?>">
													<a href="#tab_<?= $department->dept_id ?>" data-toggle="tab"><?= $department->department_name ?></a>
												</li>
												<?php
											}
										?>
									...
									<div class="tab-content">
										...
										<?php 
											foreach ($departments as $key => $department) {		
												?>
													<div class="tab-pane <?= $key == 0 ? 'active' : '' ?>" id="tab_<?= $department->dept_id?>">
														<div class="col-md-12">
										            	...
										            	{ 
										            		if($department->dept_id == $employee->dept)
																		{			
																			?>
																		<tr>
																			<td><?=$i++;?></td>
