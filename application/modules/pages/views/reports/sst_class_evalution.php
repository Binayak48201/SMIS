			...
			<div class="col-md-4 no-padding">
				<div class="note note-sm note-success padding-tb-min"><?= $evaluation->evaluation_type_name ?></div>
					<div class="col-md-12 md-radio-list">
						<?php 
							$update = FALSE;
							$options = modules::run("pages/profile/evaluation/get_evaluation_option",3,$evaluation->evaluation_type_id);
							//print_e($evaluation->evaluation_type_id);
							$remarked = modules::run("pages/evaluation/get_st_evaluated",3,$evaluation->evaluation_type_id,$st_id,$exam_id,$subject_id);
							if($options != NULL)
							{
