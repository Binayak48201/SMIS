		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					...
					<a href="<?=site_url('theme_option/manage_menu');?>">Manage Menu</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a href="#">Edit Menu</a>
					...
					<div class="col-md-12">
						<div class="portlet light">
							...
							<div class="portlet-body form">
								<form role="form" action="<?= site_url('theme_option/manage_menu/update_menu/'.$this->uri->segment(4)); ?>" method="post" role='form'>
									<?php display_alert(); ?>
									<div class="form-body">
										<div class="form-group form-md-line-input">
											<input type="text" class="form-control" name='mtitle' value="<?=$result->title?>" required placeholder="Title">
											<label for="form_control_1">Menu Title</label>
											<!-- <span class="help-block">Some help goes here...</span> -->
										</div>
										<div class="form-group form-md-line-input">
											<input type="text" class="form-control" name='mlink' value="<?=$result->link?>" required placeholder="Link">
											<label for="form_control_1">Menu Link</label>
											<!-- <span class="help-block">Some help goes here...</span> -->
										</div>
										<div class="form-group form-md-line-input">
											<input type="text" class="form-control" name='icon' id='menu-ico' value="<?=$result->icon?>" data-toggle="modal" data-target="#large" placeholder="Icon">
									...
									<div class="form-group form-md-checkboxes">
										...
										<div class="md-checkbox-inline">
											<?php 
											$type_arr=unserialize($result->access);
											$i=1;
											foreach ($user_type as $row) 
											{
												?>
												<div class="md-checkbox">
													<input type="checkbox" name='access[]' <?php if(!empty($type_arr) && in_array($row->ROLE_ID,$type_arr)){echo'checked="checked"';} ?> value='<?=$row->ROLE_ID?>' id="checkbox<?=$i?>" class="md-check">
									...
									<div class="form-actions noborder">
										<button type="submit" name='update' value="UPDATE" class="btn blue">Submit</button>
