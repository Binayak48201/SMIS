        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption font-green-haze">
              ...
              <span class="caption-subject bold uppercase">Migrate Subjects</span>
            </div>
          </div>
          <div style="overflow: hidden;" class="portlet-body">
              <?php display_alert(); ?>
              <form class=" " method="post" action='<?= site_url('pages/classes/subject_manager/migrate'); ?>' style="padding-top: 12px;">
                <div class="navbar navbar-default col-md-5"> 
                  ...
                  <div class="col-md-6">
                    <div class="form-group form-md-line-input">
                      <select class="form-control from_display_section" id='from_grade' name='from_grade' required>
                    ...
                    <div id="frm_ajax_alert" class="label label-success" style="display: none; position: absolute; margin-top: -20px">Subject Exist </div>
                  </div>
                  <!-- <div class="col-md-3">
                ...
                <div class="navbar navbar-default col-md-7"> 
                  <div class="portlet-title" style="padding: 10px;">
                    <div class="caption font-green-haze">
                  ...
                  <div class="col-md-5">
                    <div class="form-group form-md-line-input">
                      <select class="form-control to_display_section" id='to_grade' name='to_grade' required>
                        <option value="">Select Grade</option>
                        <?php if($grades!=NULL)
                        { 
                          $i=1;
                    ...
                    <div id="to_ajax_alert" class="label label-success" style="display: none; position: absolute; margin-top: -20px">Subject Migrated Already</div>
                  </div>
                  <!-- <div class="col-md-3">
