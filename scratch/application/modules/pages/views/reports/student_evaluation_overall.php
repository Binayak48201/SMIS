  ...
  <div class="page-content">
    ...
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">Overall Evaluation Report</a>
        </li>
      </ul>
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption font-green-haze">
              ...
              <span class="caption-subject bold uppercase">Overall Evaluation Report</span>
            </div>
          </div>
          <div style="overflow: hidden; min-height: 60vh;" class="portlet-body">
            ...
            <form class="" id="terminal_opt" method="post" action='' role="form" >
              <div class="col-md-2">
                <div class="form-group form-md-line-input no-margin-imp">
                  <select class="form-control display_section" name='batch_id' id='batch' required>
                    <option value="<?= current_batch(); ?>"><?= current_batch(); ?></option>
                    <!-- <?php if($batchs!=NULL)
                    { 
                      $i=1;
             ...
             <div class="col-md-3">
              ...
              <div class="col-md-2">
                 <div class="form-group form-md-line-input no-margin-imp">
                 <button name="view" value="VIEW" class="btn blue" type='submit'>View</button>
                </div>
              </div>
            </form>
