<div style="padding:0px 225px;">
<?php 
if(isset($students) && !empty($students))
{ ?>
	<div class="no-print btn-cstm" onclick="printDiv('printAll')">Print All</div>	
	<div class="clearfix"></div>
	<div id="printAll">
		<?php
		foreach ($students as $st_info) {
			$st_id = $st_info->student_id;
		...
		?>
		<div class="col-md-12 st_marksheet" id="<?= $st_id ?>_marksheet">
			<i class="btn-cstm icon-printer pull-right no-print" onclick="printDiv('<?= $st_id ?>_marksheet')" ></i>
			...
			<table class="table table-bordered table-condensed" width="100%" border="1px solid black">
				...
				<tbody>
					<tr>
						<td class="text-center">
							<?php if(isset($totaling) && $totaling == TRUE && $total_obtain > 0)
							{
			...
			<div class="col-md-6 no-padding">
				<div class="remark-title" style="border: 1px solid black; width:94%; border-collapse: collapse; margin-bottom: -1px;" ><b>Remark</b></div>
				<div class="remark-body" style="border: 1px solid black; width:94%; min-height: 75px; border-collapse: collapse; " >
