			...
			<div class="col-md-4 no-padding">
				<div class="note note-sm note-success padding-tb-min"><?= $evaluation->evaluation_type_name ?></div>
					<div class="col-md-12 md-radio-list">
						<?php 
							$update = FALSE;
							$options = modules::run("pages/profile/evaluation/get_evaluation_option",1,$evaluation->evaluation_type_id);
							//print_e($evaluation->evaluation_type_id);
							$remarked = modules::run("pages/profile/evaluation/get_st_evaluated",1,$evaluation->evaluation_type_id,$st_id,$exam_id,$section_id);
							if($options != NULL)
							{
	                  ...
	                  <?= $option->evaluation_option_name ?></label>
						...
						<div class="col-md-12 form-group form-md-line-input no-padding"><b>Feedback:</b> 
							<textarea class="form-control" placeholder="Remark" readonly="" name='remark_<?= $evaluation->evaluation_type_id ?>' ><?= $remarked != NULL ? $remarked->remarks : '' ?></textarea>
							<div class="form-control-focus">
							</div>
						</div>
          </div>
