				...
				<div class="portlet light" style="min-height: 60vh;">
					<div class="portlet-title">
						<div class="caption font-green-haze">
							...
							<span class="caption-subject bold uppercase">Student Bulk Edit</span>
						</div>
					</div>
	                ...
	                <div class='col-md-2'>
						...
						<?php
							if(isset($students) && !empty($students))
							{
								...
								<form action="<?= site_url('pages/profile/student/update_bulk_st'); ?>" method="post">
				            	...
				            	{ ?>
												<tr>
													...
													<td><input class="form-control" name="weight_<?= $student->student_id ?>" value="<?= $student->weight ?>" type="text"></td>
													<td><input class="form-control" name="hright_<?= $student->student_id ?>" value="<?= $student->height ?>" type="text"></td>
													<td><input class="form-control" name="special<?= $student->student_id ?>" value="<?= $student->special_needs ?>" type="text"></td>
												</tr>
				            		<?php
